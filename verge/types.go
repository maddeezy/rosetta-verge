...
const (
	...
	// Verge operations because anything
...
// of a Verge transaction that must be satisfied to spend
// the output.
...
// Verge transaction that satisfies the ScriptPubKey
...
// BlockchainInfo is information about the Verge network.
...
// Block is a raw Verge block (with verbosity == 2).
type Block struct {
...
// Transaction is a raw Verge transaction.
...
// Input is a raw input in a Verge transaction.
type Input struct {
...
// Output is a raw output in a Verge transaction.
type Output struct {
...
// metadata from Verge inputs and outputs.
